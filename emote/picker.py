...
class EmojiPicker(Gtk.Window):
    ...
    def open_about(self):
        ...
        about_dialog = Gtk.AboutDialog(
            ...
            authors=["Pikku-a", "Tom Watson", "Vincent Emonet"],
            artists=["Pikku-a", "Tom Watson, Matthew Wong"],
            documenters=["Irene Auñón"],
            copyright=f"© Pikku-a {datetime.now().year}",
            website_label="Source Code",
            website="https://github.com/pikku-a/hymio",
            comments="Modern popup emoji & kaomoji picker, based in Emote.  ",
